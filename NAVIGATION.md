...
- `Inspiration/` — Legacy example images. **No longer a source** — the D13 inspiration mix died with the topic-first pivot (W3.5); kept on disk only as raw material an operator may point registry `reference_images` at
