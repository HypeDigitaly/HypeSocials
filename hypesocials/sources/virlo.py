...
_CARRIED_FIELDS = frozenset({"rows_per_call"})
...
class Counters:
    ...
    **Input and output vocabulary stay disjoint** (FR-155/NFR-5). INPUT words — video, slideshow,
    ...
    pivot's Wave 3.5 — the live chain is input → topics → filter → Select → the style forecast.
    """
    ...
    def as_event(self) -> dict[str, Any]:
        ...
        return {
            ...
            "caps": {"rows_per_call": self.rows_per_call},
        }
