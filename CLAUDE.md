...
**Last updated:** 2026-08-20 (v2.3.0/D54–D55 conductor merge, SESSION H: carousel compress mode (`carousel_copy_mode`, FR-331–333), style doubling-down (9-style registry incl. quiet-luxury-night-photoreal, 4-key `styles.enabled` in shipped configs), glossary D54 carve-outs, run-deadline glossary re-based to 45 min)
