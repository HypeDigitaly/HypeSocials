...
**FR-73** *(amended v2.0.0, v2.1.0, v2.1.2, v2.3.0)*: The `meta.yaml` file is the canonical schema for all asset metadata. It records (grouped logically):

**Identity & sourcing (v2.1.0 amendments: added source_panel_count, panel_map, source_post, ref_source; v2.1.2 amendments: panel_map rows gain creator_stripped; v2.3.0 amendments: top-level copy_mode, panel_map rows gain compressed):**
