...
- `reel_reference_max_s` (default **28**) — the qualifying duration bound for the viral-video motion reference (10-pipeline FR-142; OQ-6 closed: Kie serves the full ≤30 s reference tier, and 28 leaves headroom under the ceiling).
